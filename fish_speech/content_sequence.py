...
from fish_speech.utils import restore_ndarray
...
if __name__ == "__main__":
    ...
    from flash_fish.tokenizer import FishTokenizer

    tokenizer = FishTokenizer.from_pretrained("checkpoints/agent-4b")
